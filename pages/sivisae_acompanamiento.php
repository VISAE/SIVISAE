        ...
        if (!isset($_SESSION['usuarioid'])) {
            ...
            <script type="text/javascript" language="javascript">
                    ...
                    if ($('#periodo').val() !== '') {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                var tipo_asignacion = $("#tipo_asignacion").val();
                                ...
                                $("#list_estudiantes").on("click", ".pagination a", function (e) {
                                    ...
                                    $("#list_estudiantes").load("src/acompanamientoCB.php", {
                                        "page": page,
                                        "auditor": aud,
                                        "registros": reg,
                                        "buscar": search,
                ...
                function crearReporte() {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'src/reporte_asignados_consejeria.php',
                        data: dataS,
                        beforeSend: function () {
                             startLoad();
                        },
                ...
                <div >
                    ...
                    <div align="center" style="background-color: #004669">
                        <h2 id='p_fieldset_autenticacion_2'>
                            TABLERO DE ASIGNACIÓN CONSEJERÍA
                        </h2>
                    </div>
