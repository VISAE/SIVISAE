            ...
            <script type="text/javascript" language="javascript">
                ...
                function listaEstudiantes() {
                    if ($('#periodo').val() != '') {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'src/control_estudiantes_consejeria.php',
                            data: dataString,
                            beforeSend: function () {
                                startLoad();
                                $('.lbl').show();
                            ...
                            success: function (data) {
                                ...
                                $("#list_estudiantes").on("click", ".pagination a", function (e) {
                                    ...
                                    var est = $("#selec").val();
                                    $("#list_estudiantes").load("src/control_estudiantes_consejeria.php", {
                                        "page": page,
                                        "auditor_sel": aud,
                                        "registros": reg,
                                        "buscar": search,
                ...
                function asignar() {
                    ...
                    if ($('#auditor_sel').val() != '') {
                        ...
                        if ($('#asignacion_sel').val() != '') {
                            var auditor = $('#auditor_sel').val();
                            var tipoAsg = $('#asignacion_sel').val();
                            ...
                            $.ajax({
                                data: parametros,
                                url: 'src/asignar_consejeria.php',
                                type: 'POST',
                                beforeSend: function () {
                                    $("#carg").introLoader({
                                        animation: {
                            ...
                            swal({
                                title: 'Seleccione el tipo de asignación',
                                text: '',
                                type: 'error',
                                confirmButtonColor: '#004669',
                                confirmButtonText: 'Aceptar'
                            });
                            $('#asignacion_sel').focus();
                            return false;
                        }
                ...
                function cargarAsignar() {
                    ...
                    $.ajax({
                        url: 'src/leer_archivo_cargue_consejeria.php',
                        type: 'POST',
                        // Form data
                ...
                <div >
                    ...
                    <div align="center" style="background-color: #004669" >
                        <h2 id='p_fieldset_autenticacion_2'>
                            Asignación de Estudiantes a Consejeros
                        </h2>
                    </div>
                                    ...
                                    <div align="center">
                                        <div style="background-color: #E8E8E8">
                                            <table style="width: 400px">
                                                <tr>
                                                    <td><label for="auditor_sel">Consejero (*):</label></td>
                                                    <td>
                                                        <select data-placeholder="Seleccione un consejero"  name='auditor_sel' id='auditor_sel' style="width: 200px;" tabindex='2'>";
                                                            <option value=''></option>
                                                            <?php
                                                ...
                                                <tr>
                                                    <td><label for="asignacion_sel">Tipo Asignacion (*):</label></td>
                                                    <td>
                                                        <select data-placeholder="Seleccione un tipo de asignación"  name='asignacion_sel' id='asignacion_sel' style="width: 200px;" tabindex='2'>";
                                                            <option value=''></option>
                                    ...
                                    <div align="center">
                                        ...
                                        <form id="cargar_asignacion" name="cargar_asignacion"> 
                                            <table>
                                                <tr>
                                                    <td colspan="2">
                                                        Para realizar cargue mediante archivo plano descargue el modelo <a href="<?php echo RUTA_PPAL . "modelos/modelo_cargue_consejeros.csv" ?>">Aquí</a> ó si prefiere <br>
                                                        puede crear un archivo csv(separado por comas) con la siguiente estructura:<br><br>
                                                        <b>CEDULA ESTUDIANTE, CEDULA CONSEJERO, CODIGO PERIODO, TIPO ASIGNACIÓN (1-Curso, 2-Centro)</b><br>
                                                    </td>
                                                </tr>
                                                <tr><td>
                                                        <br>
